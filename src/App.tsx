...
function App() {
  return (
    ...
    <Box component="section" sx={{ p: 2}}>
      ...
      <Box component="div" sx={{ p: 2 }}>
        <ul className="projectsList">
          <li> <h2 className="fira-mono-medium"><a href="#">Emacs Config</a></h2>
          ...
          <li> <h2 className="fira-mono-medium"><a href="https://github.com/tarffie/my-unholy-dotfiles?tab=readme-ov-file">Dotfiles</a></h2>
              <p> My home-baked dotfiles for my linux system and other side projects I did, like a gentoo setup </p> 
          </li>
          <li> <h2 className="fira-mono-medium"><a href="#">AutoLinker</a></h2>
    ...
    <Box component="section" sx={{ p: 2}}>
    <h2 className="fira-mono-medium">My work ️❤️️</h2>
